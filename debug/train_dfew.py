"""Train DFEW with Stage2 fused_output classification head."""
...
from modeling import Stage2EmotionModel  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="DFEW training with Stage2 fused head.")
    ...
    parser.add_argument("--output_root", type=str, default="/data/home/cqm/Project/Code/Ours/debug/outputs/dfew")
    ...
    parser.add_argument("--lambda_proto", type=float, default=1.0, help="Weight for L_con + L_dev.")
...
def main_worker(local_rank: int, gpu_ids: list[int], args: argparse.Namespace) -> None:
    ...
    model = Stage2EmotionModel(pool=args.pool, stage1_config=stage1_cfg)
    model.to(device)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_metrics = train_one_epoch(
            ...
            epoch=epoch,
            logger=logger,
            lambda_proto=args.lambda_proto if args.overfit_n <= 0 else 0.0,
            scaler=scaler,
